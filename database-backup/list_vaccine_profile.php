              ...
              <div class="form-group">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-3" readonly>
                    ...
                    <label>Remarks: </label>
                    <input type="text" style="color:red; font-weight: 900;" readonly name="remarks" id="remarks" class="blink_me form-control" pull-right value="<?php echo $get_vaccine_status;?>">
                    <br>
                  </div>
