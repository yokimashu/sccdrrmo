...
if (isset($_POST['insert_contactcase'])) {
    ...
    $tracer_contactno = $_POST['tracer_contactno'];
    ...
    $patient_firstname = $_POST['firstname1'];
    $patient_middlename      = $_POST['middlename1'];
    $patient_lastname  = $_POST['lastname1'];
    ...
    $patient_civilstatus     = $_POST['patient_civilstatus'];
    ...
    $name_facility1      = $_POST['name_facility1'];
    ...
    tracer_contactno      = :tracer_contactno, 
    ...
    patient_entityno = :patient_entityno,
    ...
    patient_civilstatus       = :patient_civilstatus,
