...
$PHPJasperXML->sql = "SELECT * from tbl_vaccine r
inner join tbl_assessment t on t.entity_no = r.entity_no where r.entity_no = '" . $entity_no . "' AND t.1stDose = '01_Yes' AND t.2ndDose = '01_Yes'";
