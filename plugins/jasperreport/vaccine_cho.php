...
$xml = $PHPJasperXML->load_xml_file("vaccine_cho.jrxml");
...
$PHPJasperXML->sql = "SELECT t.date_reg,CONCAT(r.firstname,' ',r.middlename,' ',r.lastname) AS fullname,t.status FROM tbl_vaccine r LEFT JOIN tbl_assessment t ON t.entity_no = r.entity_no WHERE t.bakuna_center_no = 'CBC04826' ORDER BY t.date_reg,r.lastname ASC";
