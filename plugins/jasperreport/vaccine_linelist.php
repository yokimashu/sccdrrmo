...
$xml = $PHPJasperXML->load_xml_file("vaccine_linelist.jrxml");
...
concat(lastname,', ',firstname,' ',middlename) as sinovac
FROM tbl_vaccine where sinovac = '01_Yes' order by lastname";
