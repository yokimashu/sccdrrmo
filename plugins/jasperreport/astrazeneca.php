...
$xml = $PHPJasperXML->load_xml_file("astrazeneca.jrxml");
...
$PHPJasperXML->sql = "SELECT CONCAT(t.firstname,' ',t.middlename,' ',t.lastname)
AS fullname,t.age,r.astrazeneca,a.bakuna_center,a.status
 FROM tbl_vaccine r 
 INNER JOIN tbl_individual t ON t.entity_no = r.entity_no 
 LEFT JOIN tbl_assessment a ON a.entity_no = t.entity_no where r.astrazeneca = '01_Yes' ORDER BY a.bakuna_center asc";
