...
category,sinovac,vaccinemanufacturer,1stdose,2nddose,datevaccination,t.status,firstname,middlename,lastname,bakuna_center FROM tbl_vaccine r
inner join tbl_assessment t on t.entity_no = r.entity_no
where barangay = '" .$barangay . "' and Category = '" .$description . "'
and 1stdose = '" .$dose . "' and vaccinemanufacturer = '" .$type . "' and t.status = 'VACCINATED' order by datevaccination DESC, lastname";
