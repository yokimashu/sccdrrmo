...
$xml = $PHPJasperXML->load_xml_file("vaccine_deped.jrxml");
...
$PHPJasperXML->sql = "SELECT CONCAT(lastname,', ',middlename,' ',firstname) as fullname,datecreate,category,consent,sinovac,astrazeneca FROM tbl_vaccine where employer_name like '%deped%' order by fullname asc";
