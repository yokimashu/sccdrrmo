...
$xml = $PHPJasperXML->load_xml_file("vaccination_card_longtext.jrxml");
...
$PHPJasperXML->sql = "SELECT v.entity_no,age, SUBSTRING(civilstatus, 4) AS civilstatus,fullname,v.lastname, v.firstname, v.middlename, suffix,gender,t.barangay, full_address,city,t.province, contact_no, birthdate_, PhilHealthID, category,photo,email,
...
(SELECT DISTINCT(signature) FROM tbl_vaccinators WHERE CONCAT(l_name, ', ', f_name, ' ', m_name) = (SELECT VaccinatorName FROM tbl_assessment WHERE (1stDose = '01_Yes' AND 2nddose = '02_No') AND entity_no = '". $entity_no ."')) AS 1st_dose_signature,
