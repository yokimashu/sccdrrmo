...
$xml = $PHPJasperXML->load_xml_file("vaccination_card_photo.jrxml");
...
$PHPJasperXML->sql = "SELECT v.entity_no,age, SUBSTRING(civilstatus, 4) AS civilstatus,fullname,v.lastname, v.firstname, v.middlename, suffix,gender,t.barangay, full_address,city,t.province, contact_no, birthdate_, PhilHealthID, category,email, 
