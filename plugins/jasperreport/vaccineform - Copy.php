...
$xml = $PHPJasperXML->load_xml_file("vaccineform.jrxml");
...
$PHPJasperXML->sql = "Select * FROM tbl_vaccine_profile t inner join tbl_individual r on r.entity_no = t.entity_no WHERE t.entity_no = '" . $entity_no . "'";
