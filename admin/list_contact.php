...
$get_all_contact_sql = "SELECT * FROM tbl_closecontact order by timestamp DESC ";
      ...
      <section class="content">
        <div class="card card-info">
          <div class="card-header  text-white bg-success">
            <h4> COVID CLOSE CONTACT CASES

            <a href="https://docs.google.com/forms/d/1is3X-vt-VkFEyYBoH0m0fXulgXc2nqx2_IR29rDfOyg/edit?gxids=7757#responses" style="float:right;" type="button"> View Summary
              </a>
              <br>
              <br>

            <a href="https://docs.google.com/spreadsheets/d/1XdWfU6cQ2EX183SJdUvNzmzaOUe_JQAnDpmnm8RMtMY/edit#gid=1793586305" style="float:right;" type="button"> View Responses
              </a>
                    ...
                    <table style="overflow-x: auto;" id="users" name="user" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        <?php while ($list_contact = $get_all_contact_data->fetch(PDO::FETCH_ASSOC)) { ?>
                          <tr>
                            <td><?php echo $list_contact['timestamp'];  ?></td>
                            <td><?php echo $list_contact['investigator'];  ?></td>
                            <td><?php echo $list_contact['covid_id']; ?> </td>
                            <td><?php echo $list_contact['name_index']; ?> </td>
                            <td><?php echo $list_contact['permanent_street']; ?> </td>
                            <td><?php echo $list_contact['barangay']; ?> </td>
