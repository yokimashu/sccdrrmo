    ...
    <section class="content">
            <div class="card card-info">
                    <div class="card-header  text-white bg-success">
                        <h4> List of Person Under Investigation (PUIs)  </h4>
                    </div>
                    <div class="card-body">
...
<!-- delete pum modal -->
<div class="modal fade" id="delete_PUI" role="dialog" data-backdrop="static" data-keyboard="false">
            ...
            <div class="modal-content">
              ...
              <form method="POST" action="">
                ...
                <div class="modal-footer">
                  ...
                  <input type="submit" name="delete_pui" class="btn btn-danger" value="Yes">
                </div>
              </form>
            </div>
            <!-- /.modal-content -->
