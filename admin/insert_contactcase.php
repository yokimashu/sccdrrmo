...
if (isset($_POST['insert_contactcase'])) {
    ...
    -- person_ent1       =:pentity1,
    -- person_name1      =:pname1,
    -- person_ent2       =:pentity2,
    -- person_name2      =:pname2,
    -- person_ent3       =:pentity3,
    -- person_name3      =:pname3,
    -- person_ent4       =:pentity4,
    -- person_name4      =:pname4,
    -- person_ent5       =:pentity5,
    -- person_name5      =:pname5
