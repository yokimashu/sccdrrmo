                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <div class="input-group date" data-provide="datepicker">
                                                        ...
                                                        <input type="text" class="form-control pull-right" id="datepicker" name="date_register" value=<?php echo $date_reg ?>>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <input type="text" class="form-control" id="username" name="username" placeholder="Username" id="username" value="<?php echo $user_name; ?>" required>
                                                    <div id="status"></div>
                                                </div>
                                            </div></br>
                                            ...
                                            <div class="row">
                                                <div class="col-md-1"></div>
                                                <div class="col-md-10">
                                                    <select class="form-control select2" id="transpo_type" style="width: 100%;" name="land_transpo_type" value=<?php $transpo ?>>
