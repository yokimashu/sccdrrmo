...
$file_name = 'Astrazeneca-'.$date_format. '.xlsx';
$data2 = [[
...
$seconddose = "SELECT DATE_ADD(a.`DateVaccination`, INTERVAL 10 WEEK)  AS 2ndDoseSchedule, a.entity_no, category, lastname, firstname, middlename, suffix, 
