...
<body class="hold-transition sidebar-mini">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="card card-success card-outline">
                                <div class="card-body box-profile">
                                    ...
                                    <a type="button" class="btn btn-block  btn-warning" href="../admin/view_individual.php?id=<?php echo $get_entity_no; ?> " target="_blank" title="VIEW PROFILE" style="color: white;">EDIT PROFILE
                                    </a>
                            ...
                            <?php if ($print == '1') { ?>
                                ...
                                <div class="card card-success">
                                    ...
                                    <div class="card-header">
                                        ...
                                        <h3 class="card-title">Print VaxCard</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                    ...
                                    <p class="text-muted">
                                        ...
                                        <a href="../plugins/jasperreport/vaccination_card_photo?entity_no=<?php echo $get_entity_no; ?>#toolbar=0" target="blank">
                                        ...
                                        <form role="form" enctype="multipart/form-data" method="post" id="input-form" action="update_resbakuna_card3.php">
                                ...
                                <?php } else { ?>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu" role="menu">
                                            <!-- <a class="dropdown-item" href="#">With Photo</a> -->
                                            <?php if ($vaccine_card == '1') {
                                                $disablecard = "disabled";
                                            } else {
                                            ...
                                            <a class="dropdown-item" id="vaccinecard" name="update_resbakuna_card" href="../plugins/jasperreport/vaccination_card_3rd.php?entity_no=<?php echo $get_entity_no; ?>" target="blank" title="New Vaccination Card"> WITH PHOTO
                                            </a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" id="vaccinecard" name="update_resbakuna_card"  href="../plugins/jasperreport/vaccination_card_photo.php?entity_no=<?php echo $get_entity_no; ?> " target="_blank" title="New Vaccination Card">NO PHOTO
                                            </a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" id="vaccinecard" name="update_resbakuna_card"   href="../plugins/jasperreport/vaccination_card_longtext.php?entity_no=<?php echo $get_entity_no; ?>" target="_blank" title="New Vaccination Card">LONG NAME
                                            </a>
                                            <div class="dropdown-divider"></div>
    ...
    <script>
        ...
        $("#view_individual").on("click", "#view_individual", function() {
