...
$get_all_pum_sql = "SELECT * FROM tbl_pum where status = 'Active' and health_status = 'Completed Quarantine' order by idno DESC";
...
<head>
  ...
  <title>SCCDRRMO ERP | List of Completed </title>
    ...
    <section class="content">
            <div class="card card-info">
                    <div class="card-header  text-white bg-success">
                        <h4> List of Completed Quarantine  </h4>
                    </div>
                    <div class="card-body">
...
<div class="modal fade" id="deleteComplete" role="dialog" data-backdrop="static" data-keyboard="false">
            ...
            <div class="modal-content">
              ...
              <form method="POST" action="">
                ...
                <div class="modal-footer">
                  ...
                  <input type="submit" name="delete_completed" class="btn btn-danger" value="Yes">
                </div>
              </form>
            </div>
            <!-- /.modal-content -->
