    ...
    <script>
        var dataTable = $('#users').DataTable({
            ...
            columnDefs: [{
                    ...
                    targets: -1,
                    data: null,
                    defaultContent: '<a class="btn btn-warning btn-sm printlink1" style="margin-right:10px;" data-placement="top" title="Update Schedule"> <i class="fa fa-edit"></i></a>',
                },
        ...
        $("#users tbody").on("click", ".printlink1", function() {
            ...
            $('.printlink1').attr("href", "view_schedule.php?id=" + id, '_parent');
