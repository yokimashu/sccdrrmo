...
$get_all_pum_sql = "SELECT * FROM tbl_pum where status = 'Active' and health_status = 'Home Quarantine' order by idno DESC";
...
<head>
  ...
  <title>SCCDRRMO ERP | List of Home Quarantine </title>
...
<div class="modal fade" id="deleteHome" role="dialog" data-backdrop="static" data-keyboard="false">
            ...
            <div class="modal-content">
              ...
              <form method="POST" action="">
                ...
                <div class="modal-footer">
                  ...
                  <input type="submit" name="delete_home" class="btn btn-danger" value="Yes">
                </div>
              </form>
            </div>
            <!-- /.modal-content -->
