...
foreach($result as $row)
{
 ...
 <div class="panel panel-default">
  ...
  <div class="panel-footer" align="right">
    <button '.$btndelete.' type="button" class="btn btn-default delete" id="'.$row["comment_id"].'"><i class="fa fa-trash"></i></button>
    <button type="button" class="btn btn-default reply" id="'.$row["comment_id"].'"><i class="fa fa-reply"></i></button>
  </div>
 </div>
 ';
