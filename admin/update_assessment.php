...
if (isset($_GET['entity_no'])) {
    ...
    $get_vaccineProfile_sql = "SELECT * FROM tbl_assessment a inner join tbl_vaccine v on v.entity_no = a.entity_no WHERE a.entity_no = :entity_no";
    $vaccineprofile_data = $con->prepare($get_vaccineProfile_sql);
    $vaccineprofile_data->execute([':entity_no' => $entity_no]);
                            ...
                            <section class="content">
                                <div class="card">
                                    ...
                                    <div class="card-header bg-success text-white">
                                        <h4>Update Vaccine Assessment and Screening (VAS)</h4>
                                    </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-sm-3">
                                                            ...
                                                            <select name="como_hypertension" id="como_hypertension" style="width:100%" class="form-control " value = "<?php echo $get_comorbidity01; ?>">
                                                        ...
                                                        <div class="col-sm-3">
                                                            ...
                                                            <select name="como_heart" id="como_heart" style="width:100%" class="form-control " value = "<?php echo $get_comorbidity02; ?>">
                                                        ...
                                                        <div class="col-sm-3">
                                                            ...
                                                            <select name="como_kidney" id="como_kidney" style="width:100%" class="form-control " value = "<?php echo $get_comorbidity03; ?>">
                                                        ...
                                                        <div class="col-sm-3">
                                                            ...
                                                            <select name="como_diabetes" id="como_diabetes" style="width:100%" class="form-control " value = "<?php echo $get_comorbidity04; ?>">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-3">
                                                            ...
                                                            <select name="como_asthma" id="como_asthma" style="width:100%" class="form-control " value = "<?php echo $get_comorbidity05; ?>">
                                                        ...
                                                        <div class="col-sm-3">
                                                            ...
                                                            <select name="como_immunodeficiency" id="como_immunodeficiency" style="width:100%" class="form-control " value = "<?php echo $get_comorbidity06; ?>">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <label>Cancer</label>
                                                            <select name="como_cancer" id="como_cancer" style="width:100%" class="form-control " value = "<?php echo $get_comorbidity07; ?>">
                                                        ...
                                                        <div class="col-sm-3">
                                                            ...
                                                            <option <?php if ($get_comorbidity08 == '01_Yes') echo 'selected'; ?> value="01_Yes">Yes </option value = "<?php echo $get_comorbidity08; ?>">
                                            ...
                                            <div class="card card-success card-outline" hidden id="yes-allergy">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-sm-3">
                                                            <label>Drug</label>
                                                            <select name="allergy_drug" id="allergy_drug" style="width:100%" class="form-control " value = "<?php echo $get_allergy01; ?>">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <label>Food</label>
                                                            <select name="allergy_food" id="allergy_food" style="width:100%" class="form-control "  value = "<?php echo $get_allergy02; ?>">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <label>Insect</label>
                                                            <select name="allergy_insect" id="allergy_insect" style="width:100%" class="form-control "  value = "<?php echo $get_allergy03; ?>">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <label>Latex</label>
                                                            <select name="allergy_latex" id="allergy_latex" style="width:100%" class="form-control "  value = "<?php echo $get_allergy04; ?>">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-3">
                                                            <label>Mold</label>
                                                            <select name="allergy_mold" id="allergy_mold" style="width:100%" class="form-control "  value = "<?php echo $get_allergy05; ?>">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <label>Pet</label>
                                                            <select name="allergy_pet" id="allergy_pet" style="width:100%" class="form-control "  value = "<?php echo $get_allergy06; ?>">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <label>Pollen</label>
                                                            <select name="allergy_pollen" id="allergy_pollen" style="width:100%" class="form-control "  value = "<?php echo $get_allergy07; ?>">
                                                        ...
                                                        <div class="col-sm-3">
                                                            ...
                                                            <select name="allergy_vaccine" id="allergy_vaccine" style="width:100%" class="form-control "  value = "<?php echo $get_allergy08; ?>">
