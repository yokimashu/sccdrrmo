...
$get_all_pum_sql = "SELECT * FROM tbl_pum where status = 'Active' and health_status = 'Recovered' order by idno DESC";
...
<head>
  ...
  <title>SCCDRRMO ERP | List of Recovered </title>
