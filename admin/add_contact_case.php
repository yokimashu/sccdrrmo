                                            ...
                                            <div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="text" class="form-control" id="patient_name" style=" text-transform: uppercase;" onkeyup="this.value = this.value.toUpperCase();" name="patient_name" placeholder="COVID-10 Patient Fullname">
                                                    </div>
                                                </div><br>
                                    ...
                                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                        ...
                                        <div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <label for="">Are you a health worker?:&nbsp;&nbsp; <span id="required">*</span> </label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" name="nationality" id="nationality" class="form-control" style=" text-transform: uppercase;" onkeyup="this.value = this.value.toUpperCase();" placeholder="Nationality ">
                                                </div>
                                                <div class="col-md-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" class="form-control" name="phil_no" id="phil_no" style=" text-transform: uppercase;" placeholder="Philhealth Number">
                                                </div>
                                                <div class="cold-md-3">
                                                    <label for="">Passport #: &nbsp;&nbsp; <span id="required">*</span></label>
                                                    <input type="text" class="form-control" name="passport" id="passport" style=" text-transform: uppercase;" placeholder="Passport Number" />
                                                </div>
                                                <div class="col-md-3">
