...
class geoPlugin {
	...
	var $host = 'http://www.geoplugin.net/extras/location.gp?lat={LAT}&lon={LON}';	
...
*/
	...
	function locate($ip = null) {
        ...
        $latitude = $_SERVER['latitude'];
        $longitude = $_SERVER['longitude'];
		//$host = str_replace( '{IP}', $ip, $this->host );
		//$host = str_replace( '{CURRENCY}', $this->currency, $host );
        //$host = str_replace( '{LANG}', $this->lang, $host );
        $host = str_replace( '{LAT}', $latitude, $host );
		$host = str_replace( '{LON}', $longitude, $host);
		$data = array();
