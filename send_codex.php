...
<body class="hold-transition lockscreen">
 ...
 <form class="lockscreen-credentials">
    ...
    <button type="button"  class="btn primary" style = "color: #FFFFFF; background-color:green" onclick="phoneAuth();"> SendCode</button>
...
function phoneAuth() {
    ...
    firebase.auth().signInWithPhoneNumber(number,window.recaptchaVerifier).then(function (confirmationResult) {
        ...
        sessionStorage.setItem("coderesult", coderesult);
        // alert("Message sent");
