<?php
session_start();
include('../../sccdrrmo/config/db_config.php');
...
$get_data_sql = "SELECT * FROM  tbl_vaccine where entity_no = :id";
...
if ($get_data_data->rowCount() > 0) {
  ...
  $get_vaccine_sql = "SELECT * FROM tbl_assessment where entity_no = :id";
  $get_vaccine_sql = $con->prepare($get_vaccine_sql);
  $get_vaccine_sql->execute([':id' => $entity_no]);

  while ($result = $get_vaccine_sql->fetch(PDO::FETCH_ASSOC)) {



    $get_vaccine_date     = $result['DateVaccination'];
    $get_manufacturer     = $result['VaccineManufacturer'];
    $get_batch_number     = $result['BatchNumber'];
    $get_lot_number       = $result['LotNumber'];
    $get_vaccinator       = $result['VaccinatorName'];
    $get_profession       = $result['VaccinatorProfession'];
    // $get_1st_dose         = $result['1stDose'];
    // $get_2nd_dose         = $result['2ndDose'];
    $get_deferral         = $result['Deferral'];
    $get_reason           = $result['Refusal_Reasons'];
    $get_status_assessment = $result['status'];
...
<head>
  ...
  <link rel="stylesheet" href="../../sccdrrmo/plugins/font-awesome/css/font-awesome.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="../../sccdrrmo/dist/css/adminlte.css">
  <!-- iCheck -->
  <link rel="stylesheet" href="../../sccdrrmo/plugins/iCheck/flat/blue.css">
  <!-- Morris chart -->
  <link rel="stylesheet" href="../../sccdrrmo/plugins/morris/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="../../sccdrrmo/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
  <!-- Date Picker -->
  <link rel="stylesheet" href="../../sccdrrmo/plugins/datepicker/datepicker3.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="../../sccdrrmo/plugins/daterangepicker/daterangepicker-bs3.css">
  <!-- bootstrap wysihtml5 - text editor -->
  <link rel="stylesheet" href="../../sccdrrmo/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
  <link rel="stylesheet" href="../../sccdrrmo/plugins/pixelarity/pixelarity.css">
  <link rel="stylesheet" href="../../sccdrrmo/plugins/datatables/dataTables.bootstrap4.css">
  <link rel="stylesheet" href="../../sccdrrmo/plugins/select2/select2.min.css">
...
<body>
  ...
  <section class="content">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="card card-success card-outline">
            <div class="card-body box-profile">
              <div class="text-center">
                <img class="profile-user-img img-fluid img-circle" src="../../sccdrrmo/flutter/images/<?php echo $get_photo ?>">
              </div>
          ...
          <div class="card card-success">
            <div class="card-header">
              <h3 class="card-title">Vaccine Information</h3>
            </div>
            <!-- /.card-header -->
            <?php if($get_status_assessment == 'VACCINATED') { ?>
            <div class="card-body">

            <strong><i class="fas fa-info-circle"></i>Status</strong>
              <p class="text-muted">
                <?php echo $get_status_assessment; ?></p>
                
              <hr>

    
              <strong><i class="fas fa-syringe"></i>1st Dose</strong>
              <p class="text-muted">
                <?php echo $get_vaccine_date; ?></p>
                
              <hr>

              <strong><i class="fas fa-industry"></i> Vaccine Manufacturer</strong>
              <p class="text-muted">
                <?php echo $get_manufacturer; ?></p>
              <hr>


              <strong><i class="fas fa-syringe"></i> Batch Number</strong>
              <p class="text-muted">
                <?php echo $get_batch_number; ?></p>
              <hr>

              <strong><i class="fas fa-syringe"></i> Lot Number</strong>
              <p class="text-muted">
                <?php echo $get_lot_number; ?></p>
              <hr>

              <strong><i class="fas fa-user-md"></i> Vaccinator</strong>
              <p class="text-muted">
                <?php echo $get_vaccine_date; ?></p>
              <hr>

              <strong><i class="fas fa-briefcase"></i> Profession of Vaccinator</strong>
              <p class="text-muted">
                <?php echo $get_profession; ?></p>
              <hr>
              
              <strong><i class="fas fa-syringe"></i> 2nd Dose</strong>
              <p class="text-muted">TO BE SCHEDULED</p>
                </p>
              <hr>

            </div>
            <?php } else if($get_status_assessment == 'DEFERRAL') { ?>
            <div class="card-body">
            ...
            <strong><i class="fas fa-info-circle"></i> Status</strong>
              ...
              <strong><i class="fas fa-exclamation-circle"></i> Reason for Deferral</strong>
              <p class="text-muted">
                <?php echo $get_deferral; ?></p>
                </p>
              <hr>

            </div>
            <?php } else if($get_status_assessment == 'REFUSAL') {?>
            <div class="card-body">
            ...
            <strong><i class="fas fa-info-circle"></i> Status</strong>
              ...
              <strong><i class="fas fa-exclamation-circle"></i> Reason for Refusal</strong>
              <p class="text-muted">
                <?php echo $get_reason; ?></p>
                </p>
              <hr>

            </div>
            <?php } else if ($get_status_assessment == 'VAS') {?>
            <div class="card-body">
            <label>NOT YET REGISTERED FOR VACCINATION</label>
            </div>
            <?php } ?>
        ...
        <div class="col-md-9">
          ...
          <section class="content">
            <div class="card">
              ...
              <div class="card-header bg-success text-white">
                <?php if ($registered == 1) { ?>
                  <h4>Update Vaccine Record
                    ...
                    <a href="../plugins/jasperreport/vaccineform.php?entity_no=<?php echo $get_entity_no ?>" target="_blank" style="float:right;" type="button" class="btn btn-warning bg-gradient-warning" title="Print">
                      <i class="nav-icon fa fa-print"></i></a>


                  </h4>
                <?php } else { ?>
                  <h4>New Vaccine Record
              ...
              <div class="card-body">
                <div class="box-body">
                  <form role="form" name="formVaccine" enctype="multipart/form-data" method="post" id="input-form" action="insert_vaccine.php">
                      ...
                      <select class="form-control select2" style="width: 100%;" id="entity1" name=" entity_no" value="">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-3">
                            ...
                            <input required type="text" class="form-control" id="firstname" name="firstname" onkeyup="this.value = this.value.toUpperCase();" style=" text-transform: uppercase;" placeholder="First name" value="<?php echo $get_firstname; ?>">
                          </div>

                          <div class="col-sm-3">
                            <label>Middle name: </label>
                            <input required type="text" class="form-control" id="middlename" name="middlename" onkeyup="this.value = this.value.toUpperCase();" style=" text-transform: uppercase;" placeholder="Middle name" value="<?php echo $get_middlename; ?>">

                          </div>
                          <div class="col-sm-3">
                            <label>Last name : &nbsp;&nbsp; <span id="required">*</span></label>
                            <input required type="text" class="form-control" id="lastname" name="lastname" onkeyup="this.value = this.value.toUpperCase();" style=" text-transform: uppercase;" placeholder="Last name" value="<?php echo $get_lastname; ?>">
                          </div>
                          <div class="col-sm-3">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                        ...
                        <?php if ($get_profession == '19_Other') { ?>
                          <div class="col-sm-4" id='indicate'>
                          <?php } else { ?>
                            <div class="col-sm-4" id='indicate' hidden>
                            <?php } ?>
    ...
    reserved.
          ...
          <!-- FastClick -->
          <script src="../../sccdrrmo/plugins/fastclick/fastclick.js"></script>
          <!-- AdminLTE App -->
          <script src="../../sccdrrmo/dist/js/adminlte.min.js"></script>
          ...
          <script src="../../sccdrrmo/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
          <!-- datepicker -->
          <script src="../../sccdrrmo/plugins/datepicker/bootstrap-datepicker.js"></script>
          <!-- CK Editor -->
          <script src="../../sccdrrmo/plugins/ckeditor/ckeditor.js"></script>
          <!-- Bootstrap WYSIHTML5 -->
          <script src="../../sccdrrmo/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
          <!-- Slimscroll -->
          <script src="../../sccdrrmo/plugins/slimScroll/jquery.slimscroll.min.js"></script>
          <script src="../../sccdrrmo/dist/js/adminlte.js"></script>
          <script src="../../sccdrrmo/dist/js/demo.js"></script>
          <script src="../../sccdrrmo/plugins/pixelarity/pixelarity-face.js"></script>
          <script src="../../sccdrrmo/plugins/cameracapture/webcam-easy.min.js"></script>
          <script src="../../sccdrrmo/plugins/sweetalert/sweetalert.min.js"></script>
          <script src="../../sccdrrmo/plugins/select2/select2.full.min.js"></script>
          ...
          <script>
            ...
            //   var firstname = document.forms["formVaccine"]["firstname"].value;
            //   if (firstname == "") {
