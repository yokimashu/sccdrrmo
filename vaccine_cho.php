...
$PHPJasperXML->sql = "SELECT t.date_reg,r.lastname,r.firstname,r.middlename,t.status FROM tbl_vaccine r LEFT JOIN tbl_assessment t ON t.entity_no = r.entity_no WHERE t.status = 'VACCINATED' ORDER BY r.lastname ASC";
