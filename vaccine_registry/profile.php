...
$get_all_category_sql = "SELECT * FROM tbl_category where idno = '06'";
        ...
        <div class="col-md-3">
          ...
          <div class="card card-success card-outline">
            <div class="card-body box-profile">
              <div class="text-center">
                <img class="profile-user-img img-fluid img-circle" src="../flutter/images/<?php echo $get_photo ?>">
              </div>
          ...
          <div class="card card-success">
            ...
            <div class="card-body">
              ...
              <strong><i class="fa fa-user"></i> First Name <span id="required">*</span></strong>
              ...
              <p class="text-muted">
                ...
                <strong><i class="fa fa-user"></i> Middle Name  <span id="required">*</span></strong>
              ...
              <p class="text-muted">
                ...
                <strong><i class="fa fa-user"></i> Last Name  <span id="required">*</span></strong>
              ...
              <p class="text-muted">
                ...
                <strong><i class="fa fa-user"></i> Extension Name</strong>
              ...
              <p class="text-muted">
                ...
                <strong><i class="fa fa-users"></i> Gender  <span id="required">*</span></strong>
              ...
              <p class="text-muted">
                ...
                <strong><i class="fa fa-calendar-o"></i> Birthdate  <span id="required">*</span></strong>
              ...
              <strong><i class="fa fa-file-text-o mr-1"></i> Civil Status  <span id="required">*</span></strong>
              ...
              <strong><i class="fa fa-mobile"></i> Contact Number  <span id="required">*</span></strong>
                ...
                <div class="card-body">
                  <div class="box-body">
                    <form role="form" enctype="multipart/form-data" method="post" id="input-form" action="insert_vaccine.php">
                      ...
                      <div class="card card-success card-outline" hidden>
                        <div class="card-header">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          ...
                          <input type="text" class="form-control" name="emp_lgu" id="emp_lgu" onkeyup="this.value = this.value.toUpperCase();" style=" text-transform: uppercase;" placeholder="LGU" value="<?php echo $employerlgu;?>">
                  ...
                  <div class="card card-success card-outline">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          <label>Are you willing to be vaccinated? &nbsp;&nbsp; <span id="required">*</span> </label>
